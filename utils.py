...
class PerformanceTimer():
    ...
    def timePerFrame(self,framesPerRecord):
        return ( self.averageTime() / framesPerRecord )

    def getFramerate(self,framesPerRecord = 1):
        if not len(self.records):
            return 0
        return ( framesPerRecord//self.averageTime() )
